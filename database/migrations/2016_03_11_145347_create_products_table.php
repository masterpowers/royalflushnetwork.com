...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->json('images')->nullable(); // Admin MultipleUpload
            $table->json('attributes')->nullable(); // Admin add Color/Size
            $table->json('dimensions')->nullable(); // Admin Add LxWxH Wt. Ml
